...
def dates(start_date: str, time_t: int, time_pr: int, hour_konsul: int, hour_exz: int) -> tuple:
    ...
    day_consultation = day_theory_func(hour_konsul)
    day_practice = day_theory_func(time_t - time_pr - hour_exz - hour_konsul)
    ...
    return start_date, date_out[day_theory - 1], date_out[day_theory], date_pr, date_out[len(date_out) - 2], \
           date_out[len(date_out) - 1], date_out, total_time, time_t
